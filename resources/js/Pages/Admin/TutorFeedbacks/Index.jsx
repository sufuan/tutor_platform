...
export default function Index({ auth, feedbacks }) {
    ...
    const handleApprove = (feedbackId) => {
        if (confirm('Are you sure you want to approve this feedback?')) {
            router.post(route('admin.tutor-feedbacks.approve', feedbackId));
        }
    };

    const handleReject = (feedbackId) => {
        if (confirm('Are you sure you want to reject this feedback?')) {
            router.post(route('admin.tutor-feedbacks.reject', feedbackId));
        }
    };

    const handleDelete = (feedbackId) => {
        if (confirm('Are you sure you want to delete this feedback? This action cannot be undone.')) {
            router.delete(route('admin.tutor-feedbacks.destroy', feedbackId));
        }
    };
            ...
            <div className="py-6">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-3xl font-bold text-gray-900">Tutor Feedbacks</h1>
                    </div>
