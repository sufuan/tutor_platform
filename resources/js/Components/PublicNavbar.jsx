...
export default function PublicNavbar() {
    ...
    return (
        <>
            {/* Top Bar */}
            <div className="bg-[#0F48A1] text-white">
                        ...
                        <div className="hidden md:flex items-center space-x-1">
                            {navigation.map((item) => (
                                <Link
                                    key={item.name}
                                    href={item.href}
                                    className="px-3 py-2 text-sm font-medium text-gray-700 hover:text-[#0F48A1] hover:bg-gray-50 rounded-md transition-colors"
                                >
                                    {item.name}
                                </Link>
                            ))}
                            ...
                            {auth ? (
                                ...
                                <>
                                    ...
                                    <Link href="/tutor/signup">
                                        <Button className="bg-[#0F48A1] hover:bg-[#0F48A1]/90 text-white">
                                            Become a Tutor
                                        </Button>
                                    </Link>
                                </>
                                    ...
                                    {auth ? (
                                        ...
                                        <div className="pb-4 border-b space-y-2">
                                            ...
                                            <Link href="/tutor/signup" onClick={() => setMobileMenuOpen(false)}>
                                                <Button className="w-full bg-[#0F48A1] hover:bg-[#0F48A1]/90 text-white">
                                                    Become a Tutor
                                                </Button>
                                            </Link>
                                        </div>
                                    ...
                                    <nav className="flex flex-col space-y-2">
                                        {navigation.map((item) => (
                                            <Link
                                                ...
                                                className="px-3 py-2 text-base font-medium text-gray-700 hover:text-[#0F48A1] hover:bg-gray-50 rounded-md transition-colors"
                                            >
                                                {item.name}
                                            </Link>
                                        ))}
